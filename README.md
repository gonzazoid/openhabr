...
я планирую перейти на [pg-then](https://github.com/coderhaoxin/pg-then) и шаблонизироать работу с базой (но не ORM), но пока так, по колхозному, на коллбэках и ручками.
